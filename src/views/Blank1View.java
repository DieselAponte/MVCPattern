...
import javax.swing.*;
import controllers.Blank1Controller;
import core.View;
import core.Model;

public class Blank1View extends JPanel implements View {
    private final Blank1Controller blank1Controller;
    ...
    public Blank1View(Blank1Controller blank1Controller) {
        this.blank1Controller = blank1Controller;
        make_frame();
